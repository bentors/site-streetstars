  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 selection:bg-white selection:text-black">
      ...
      >
        ...
        <div className="w-full bg-zinc-900/80 border border-white/10 p-5 rounded-sm mb-8">
          <p className="text-[10px] text-white/40 font-mono leading-relaxed uppercase tracking-wider">
            A integração com o Mercado Pago estará disponível em breve. Entraremos em contato para confirmar o pagamento.
          </p>
        </div>
